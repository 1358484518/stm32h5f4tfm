...
ns_app/tfm_src/%.o ns_app/tfm_src/%.su ns_app/tfm_src/%.cyclo: ../ns_app/tfm_src/%.c ns_app/tfm_src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m33 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32H5F4xx -DDOMAIN_NS=1 -DCONFIG_TFM_FLOAT_ABI=2 -DCONFIG_TFM_ENABLE_CP10CP11 -DPLATFORM_DEFAULT_CRYPTO_KEYS -DCONFIG_TFM_USE_TRUSTZONE -DTFM_ISOLATION_LEVEL=1 -DTFM_PARTITION_CRYPTO -DTFM_PARTITION_INTERNAL_TRUSTED_STORAGE -DTFM_PARTITION_PROTECTED_STORAGE -DTFM_PARTITION_FIRMWARE_UPDATE -DTFM_PARTITION_INITIAL_ATTESTATION -DTFM_PARTITION_PLATFORM -DTFM_PSA_CRYPTO_CLIENT_ONLY '-DTF_PSA_CRYPTO_CONFIG_FILE="mbedtls/tf_psa_crypto_config.h"' '-DTARGET_CONFIG_HEADER_FILE="config_tfm_target.h"' -DBL2 -DBL2_HEADER_SIZE=0x400 -DBL2_TRAILER_SIZE=0x3000 -DMCUBOOT_IMAGE_NUMBER=2 -DTFM_NS_LOG -DNDEBUG '-DTF_PSA_CRYPTO_USER_CONFIG_FILE="ns_crypto_user.h"' '-DMBEDTLS_USER_CONFIG_FILE="ns_mbedtls_user.h"' -DMBEDTLS_ALLOW_PRIVATE_ACCESS -c -I"/workspace/tfmcubeideproject/STM32CubeIDE/ns_app" -I../ns_app/mbedtls-4.1.1/include -I../ns_app/mbedtls-4.1.1/tf-psa-crypto/include -I../ns_app/mbedtls-4.1.1/library -I../ns_app/mbedtls-4.1.1/tf-psa-crypto/core -I../ns_app/mbedtls-4.1.1/tf-psa-crypto/drivers/builtin/include -I../ns_app/mbedtls-4.1.1/tf-psa-crypto/drivers/builtin/src -I../ns_app/mbedtls-4.1.1/tf-psa-crypto/extras -I../ns_app/mbedtls-4.1.1/tf-psa-crypto/platform -I../ns_app/mbedtls-4.1.1/tf-psa-crypto/utilities -I../spe/api_ns/interface/include -I../spe/api_ns/interface/include/crypto_keys -I../spe/api_ns/platform/include -I../spe/api_ns/platform/boards -I../spe/api_ns/platform/Device/Include -I../spe/api_ns/platform/ext/cmsis/Include -I../spe/api_ns/platform/ext/cmsis/Include/m-profile -I../spe/api_ns/platform/ext/common -I../spe/api_ns/platform/hal/Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
